    ...
    <Timeline lineColor={'#ddd'}>
      ...
      >
        ...
        <p>
          ...
          techniques and technologies (full websites, customer journeys, landing
          pages, HTML ads).
        </p>
        <p>
        ...
        <p>
          ...
          SEO team, PPC, testers and implementation staff.
        </p>
        <p>• Ensuring cross-platform optimisation across required devices.</p>
        <p>
      ...
      >
        ...
        <p>
          • Taking ownership of, and managing / seeing through a project from
      ...
      >
        ...
        <p>• Checking that the full website is reponsive on all browsers </p>
      ...
      >
        ...
        <p>
          • Supplied all deliveries to the clients personally which made me
          dependable and punctual.
        </p>
        <p>
          • Managed my time for projects and their deadlines which helped me
      ...
      >
        ...
        <p>
          • Read over contracts thoroughly and ensure that contract requirement
          is met.
        </p>
        <p>
          • Made cost estimations for different types of refurbishments with
          various scales of projects.
        </p>
        <p>
          • Lead a team of over fifteen employees which strongly improved my
      ...
      >
        ...
        <p>• Installed software on computers for customers independently.</p>
        <p>• Regularly took computers apart and rebuilt them for customers.</p>
